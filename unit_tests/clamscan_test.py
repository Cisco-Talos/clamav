...
import testcase
from testcase import STRICT_ORDER, ANY_ORDER
...
class TC(testcase.TestCase):
    ...
    def setUpClass(cls):
        ...
        # 1. malformed file tha twill alert with  --alert-broken-media
    ...
    def test_clamscan_11_heuristic(self):
        '''
        ...
        expected_results = ['Test.Pattern.Match.UNOFFICIAL FOUND']
    ...
    def test_clamscan_11_heuristic_no_other_alert(self):
        '''
        This test uses a ZIP that has two things:
        1. malformed file tha twill alert with  --alert-broken-media
        2. the clam.exe file that will alert normally.
        ...
        unexpected_results = ['Test.Pattern.Match.UNOFFICIAL FOUND']
        self.verify_output(output.out, expected=expected_results, unexpected=unexpected_results)

    def test_clamscan_11_heuristic_precedence(self):
        '''
        This test uses a ZIP that has two things:
        1. malformed file tha twill alert with  --alert-broken-media
        2. the clam.exe file that will alert normally.
    ...
    def test_clamscan_11_heuristic_allmatch(self):
        '''
        This test uses a ZIP that has two things:
        1. malformed file tha twill alert with  --alert-broken-media
        2. the clam.exe file that will alert normally.
    ...
    def test_clamscan_11_heuristic_allmatch_precedence(self):
        '''
        This test uses a ZIP that has two things:
        1. malformed file tha twill alert with  --alert-broken-media
        2. the clam.exe file that will alert normally.
