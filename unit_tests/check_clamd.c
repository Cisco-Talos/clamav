...
#define INSTREAM_MAX " StreamMaxLength=26214400"

#define VCMDS_REPLY VERSION_REPLY "| COMMANDS: SCAN QUIT RELOAD PING CONTSCAN VERSIONCOMMANDS VERSION STREAM END SHUTDOWN MULTISCAN FILDES STATS IDSESSION INSTREAM" INSTREAM_MAX " DETSTATSCLEAR DETSTATS ALLMATCHSCAN"
