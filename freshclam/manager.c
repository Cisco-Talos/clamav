               ...
               unsigned int can_whitelist, unsigned int attempt)
{
    ...
    *ims = -1;
    ...
    if (!strstr(buffer, "HTTP/1.1 200") && !strstr(buffer, "HTTP/1.0 200") && !strstr(buffer, "HTTP/1.1 206") && !strstr(buffer, "HTTP/1.0 206")) {
        char *respcode = NULL;
         ...
         unsigned int attempt)
{
    ...
    if (nodb) {
        ...
        if (ret) {
            ...
            if (buildcld(tmpdir, dbname, newfile,
        ...
        if ((dnsreply = dnsquery(dnsdbinfo, T_TXT, &ttl))) {
            ...
            if (dnsreply) {
                ...
                if ((newver = cli_strtok(dnsreply, 0, ":"))) {
                    ...
                    vstr[31] = 0;
                    if (vwarning && !strstr(vstr, "devel") && !strstr(vstr, "beta") && !strstr(vstr, "rc")) {
                        pt = strchr(vstr, '-');
