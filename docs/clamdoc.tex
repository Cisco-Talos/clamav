...
\begin{document}
    ...
    \pagestyle{empty}
    \includegraphics[width=353pt]{html/clam.png}
    \vspace{3cm}
    \begin{flushright}
	\rule[-1ex]{8cm}{3pt}\\
	\huge Clam AntiVirus 0.99\\
...
N * * * *	/usr/local/bin/freshclam --quiet
	...
	\item Watch your entire filesystem only using the \verb+clamd.conf+
	      OnAccessMountPath option. While this will put the on-access scanner
	      into NotifyOnly mode, it will prevent potential system lockups caused
	      by fanotify's blocking functionality.
    \end{itemize}
