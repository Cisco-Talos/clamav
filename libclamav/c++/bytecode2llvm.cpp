...
#ifndef DEBUGERR
#define DEBUGERR llvm::errs() << "<" << __FUNCTION__ << "::" << __LINE__ << ">"
#endif //DEBUGERR
    ...
    class RuntimeLimits : public FunctionPass {
        ...
        bool loopNeedsTimeoutCheck(ScalarEvolution &SE, const Loop *L, BBMapTy &Map) {
            ...
            if (apicalls > ApiThreshold) {
                DEBUGERR << "apicall threshold exceeded: " << apicalls << "\n";
                return true;
            }
...
#define WATCHDOG_IDLE 10
                                            ...
                                            const struct cli_bc_func *func)
                                    {
                                        ...
                                        if (ctx->bytecode_timeout) {
                                            //DEBUGERR << "DEBUGGING::TIMEOUT::CALLINGDISARM<END>\n";
					 ...
					 * determine if there is any reason to
					 * keep it.
					 */
                                            ...
                                            static Metadata *findDbgGlobalDeclare(GlobalVariable *V) {
                                                ...
                                                for (unsigned i = 0, e = NMD->getNumOperands(); i != e; ++i) {
                                                    ...
                                                    if (DIGlobalVariable(DIG).getGlobal() == V)
                                                        return DIG;
#else
                                                    llvm::errs() << "REMNOVED, find replacement<END>\n";
                                                    //https://lists.llvm.org/pipermail/cfe-commits/Week-of-Mon-20150413/127437.html
#endif
                                                }
                                                return 0;
                                            }
                                                ...
                                                static Metadata *findDbgSubprogramDeclare(Function *V) {
                                                    ...
                                                    for (unsigned i = 0, e = NMD->getNumOperands(); i != e; ++i) {
                                                        ...
                                                        if (DISubprogram(DIG).getFunction() == V)
                                                            return DIG;
#else
                                                        llvm::errs() << "<" << __LINE__ << ">" << "REMOVED<END>\n";
#endif
                                                    }
                                                    return 0;
                                                }
